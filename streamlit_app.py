...
# -----------------------------
def show_report():
    st.title("📑 미림마이스터고 1학년 4반 보고서")
    st.markdown(
        """
        ## 보고서 제목 (가제): 미림마이스터고 1학년 4반 학생을 위한 미세먼지 위험 알림과 실천 방법 연구  

        ### 서론: 우리가 이 보고서를 쓰게 된 이유  
        최근 몇 년 동안 날씨 예보에서 가장 자주 등장하는 단어 중 하나가 ‘미세먼지’이다.  
        등굣길 아침마다 마스크를 쓰고, 체육 수업이 실내로 바뀌는 일이 흔해졌다. 하지만 단순히 불편함을 넘어서,  
        미세먼지가 우리 건강과 생활에 어떤 영향을 주는지, 그리고 청소년인 우리가 스스로 어떻게 대응해야 하는지는 제대로 이야기되지 않는다.  
        그래서 우리는 미세먼지 문제를 데이터와 실제 사례를 통해 확인하고, 학생으로서 실천할 수 있는 방법을 제시하기 위해 이 보고서를 작성하게 되었다.  

        ---

        ### 본론 1: 데이터로 보는 미세먼지의 영향  
        **Point:** 지난 10년간 미세먼지는 우리 삶에 점점 더 큰 위협이 되고 있다.  
        **Reason:** 미세먼지 농도는 꾸준히 상승하고 있으며, 계절과 지역에 따라 심각한 수준을 기록해 청소년 건강에도 직접적인 영향을 미치고 있다.  
        **Example:** 환경부 자료에 따르면, 수도권의 연평균 초미세먼지(PM2.5) 농도는 2013년 23㎍/㎥에서 2022년 29㎍/㎥로 증가했다.  
        또한 질병관리청 조사 결과, 미세먼지 농도가 높았던 시기에는 청소년 천식·기관지염 진료 건수가 최대 1.4배 늘어난 것으로 확인되었다.  
        **Point:** 이처럼 미세먼지 증가는 단순한 환경 문제가 아니라, 청소년의 건강과 학교 생활을 직접적으로 위협하는 요인임이 분명하다.  

        ---

        ### 본론 2: 미세먼지가 학생 건강과 활동에 미치는 실제 영향  
        **Point:** 미세먼지는 청소년의 건강을 해치고 학교 생활의 기본적인 활동까지 제한한다.  
        **Reason:** 호흡기와 면역 체계가 아직 완전히 발달하지 않은 청소년은 미세먼지에 더욱 취약하며, 이는 곧 학습권과 생활권의 제약으로 이어진다.  
        **Example:** 실제로 미세먼지 ‘나쁨’ 단계가 지속되면 학교 체육 수업이 실내 이론으로 대체되거나 취소되고, 운동장·야외 놀이 시설 이용이 제한된다.  
        또한 보건복지부 통계에 따르면, 미세먼지 고농도 주간에 청소년의 호흡기 질환 진료율은 평소 대비 18% 이상 높아졌다.  
        학생 개인 차원에서는 기침, 두통, 피부 가려움, 피로감 등 다양한 증상이 보고되었다.  
        **Point:** 따라서 미세먼지는 단순히 ‘마스크 착용으로 해결되는 문제’가 아니라, 학생들의 건강권과 생활권을 동시에 위협하는 심각한 사회적 문제로 인식해야 한다.  

        ---

        ### 결론: 청소년 건강과 안전한 활동을 위한 학생 주도 제언  
        **Point:** 미세먼지는 청소년의 건강과 일상 활동에 실질적 피해를 주기 때문에, 학생 스스로 대응하고 행동해야 한다.  
        **Reason:** 정부와 학교 차원의 대책도 중요하지만, 일상에서 학생이 스스로 실천할 수 있는 작은 행동이 모여 더 큰 변화를 만든다.  
        **Example:**  
        1. 마스크 착용과 등하교 전 공기질 확인은 기본적인 자기 보호 수단이다.  
        2. ‘미세먼지 경보 알림제’를 학급 단위로 운영하여 실외 활동 여부를 학생 스스로 판단할 수 있도록 한다.  
        3. 교실 내 공기정화기·식물 키우기 같은 작은 실천도 효과가 있으며, 장기적으로는 ‘학생 미세먼지 감시단’을 만들어 교내 대기질 변화를 기록하고 교육청에 건의할 수도 있다.  
        **Point:** 결국 청소년은 단순한 피해자가 아니라, 스스로 건강을 지키고 사회적 변화를 만들어낼 수 있는 주체다.  
        따라서 우리는 미세먼지를 정확히 이해하고, 생활 속에서 실천하며, 목소리를 내는 행동을 통해 안전한 학교 환경을 만들어가야 한다.  
...
# -----------------------------
def main():
    st.set_page_config(page_title="PM2.5 데이터/보고서", layout="wide")

    menu = st.sidebar.radio("📌 목차", ["자료", "보고서"])
